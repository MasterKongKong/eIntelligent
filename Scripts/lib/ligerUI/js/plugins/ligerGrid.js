...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        getDeleted: function ()
        {
            //Update by Royal @ 2016/4/11 set default object, when it undefined.
            if (this.deletedRows == undefined)
                this.deletedRows = [];
        ...
        _getHtmlFromData: function (data, frozen)
        {
            ...
            for (var i = 0, l = data.length; i < l; i++)
            {
                ...
                $(g.columns).each(function (columnindex, column)
                {
                    ...
                    if (this.color) //Add by Ziv at 2016/4/27
                    {
                        gridhtmlarr.push('background-color: ' + this.color + '; ');
                    }
                    gridhtmlarr.push(' ">');
